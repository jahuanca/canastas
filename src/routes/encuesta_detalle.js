...
router.post('/rangeDate', encuesta_detalle.getEncuesta_DetallesByRange)
router.get('/id_encuesta/:id', encuesta_detalle.getEncuesta_DetallesByIdEncuesta)
...
router.post('/migracion', encuesta_detalle.migracion)
